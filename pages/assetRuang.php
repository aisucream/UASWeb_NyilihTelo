                  ...
                  if($tampil["status"]=="Tersedia"){
                    echo "
                      <tr>
                        ...
                        <td>        
                        <form action=./stack/formruang.php method=post class=button-pinjam>
                          <input type=hidden name=id value=$tampil[id_ruangan]>
                    ...
                    echo "
                      <tr>
                        ...
                        <td>                        
                          <form action=./stack/formruang.php method=post class=button-pinjam>
                          <input type=hidden name=id value=$tampil[id_ruangan]>
                          <input type=submit class=btn-disabled name=pinjam value=Pinjam disabled=disabled>
                        </form></td>
                      </tr>
                    ";
                  }

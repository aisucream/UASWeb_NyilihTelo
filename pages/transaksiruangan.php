...
<head>
  ...
  <!-- CSS Native -->
  <link rel="stylesheet" href="../assets/dist/css/dashboard/order.css" />
  <!-- ---- -->
...
<body>
  <div class="container">
    ...
    <main>
      <div class="navbar">
        <h1>Transaksi Peminjaman Ruangan</h1>
      </div>
      <!-- end of navbar -->
      ...
      <div class="row-1">
        <div class="room-order">
          <div class="header-room">
            <a href="transaksi.php">Transaksi Barang</a>
            <a href="transaksiruangan.php">Transaksi Ruangan</a>
          </div>
          <table>
            <thead>
              <tr>
                ...
                if ($data1['status'] === 'acc') {
                  echo "
                      <tr>
                        ...
                        <td class=succes-color>$data1[status]</td>
                      </tr>
                      ";
                } elseif ($data1['status'] === 'diproses') {
                  echo "
                      <tr>
                        <td>$data1[ruangan]</td>
                        <td>$data1[tgl_pinjam]</td>
                        ...
                        <td>$data1[kebutuhan]</td>
                        <td>$data1[partisipan]</td>
                        <td class=third-color>$data1[status]</td>
                      </tr>
                      ";
                }

...
if (isset($_GET['id'])) {
    ...
    function update($parameter)
    {
        ...
        global $conn;
        $update_pinjam_barang_query = "UPDATE pjbarang SET status='acc' WHERE id_user=$parameter";
        $update_pinjam_ruangan_query = "UPDATE pjruang SET status='acc' WHERE id_user=$parameter";
